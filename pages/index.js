...
export default function Home() {
  return (
    <>
      <Head>
        <title>RepMax | Are You Stronger Than Average? | Free 1RM Calculators</title>
        <meta
          name="description"
        ...
        />
        <link rel="canonical" href="https://repmax-app.vercel.app/" />
        <meta property="og:title" content="RepMax | Are You Stronger Than Average?" />
        <meta
          property="og:description"
          content="Free 1-rep max calculators and strength standards. Enter your numbers, see your tier."
        />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://repmax-app.vercel.app/og-image.png" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="RepMax | Are You Stronger Than Average?" />
        <meta
